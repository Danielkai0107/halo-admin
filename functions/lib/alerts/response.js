...
exports.declineAlertAssignment = exports.acceptAlertAssignment = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const sendMessage_1 = require("../line/sendMessage");
// 接受警報分配
exports.acceptAlertAssignment = functions.https.onCall(async (data, context) => {
    try {
...
// 拒絕警報分配
exports.declineAlertAssignment = functions.https.onCall(async (data, context) => {
    var _a;
    try {
