...
exports.unbindDeviceFromLineUser = exports.bindDeviceToLineUser = void 0;
...
exports.bindDeviceToLineUser = (0, https_1.onRequest)(async (req, res) => {
  ...
  try {
    ...
    // 檢查設備綁定狀態
    if (
      (deviceData === null || deviceData === void 0
        ? void 0
    ...
    if (
      (lineUserData === null || lineUserData === void 0
        ? void 0
    ...
    const archiveAndDeleteActivities = async (snapshot) => {
      ...
      snapshot.docs.forEach((doc) => {
        ...
        batch.set(anonymousDoc, {
          ...
          deviceId: deviceId,
          timestamp:
            (_a = data.timestamp) !== null && _a !== void 0 ? _a : null,
          gatewayId:
            (_b = data.gatewayId) !== null && _b !== void 0 ? _b : null,
          gatewayName:
            (_c = data.gatewayName) !== null && _c !== void 0 ? _c : null,
          gatewayType:
            (_d = data.gatewayType) !== null && _d !== void 0 ? _d : null,
          latitude: (_e = data.latitude) !== null && _e !== void 0 ? _e : null,
          longitude:
            (_f = data.longitude) !== null && _f !== void 0 ? _f : null,
          rssi: (_g = data.rssi) !== null && _g !== void 0 ? _g : null,
          triggeredNotification:
            (_h = data.triggeredNotification) !== null && _h !== void 0
              ? _h
              : false,
          notificationType:
            (_j = data.notificationType) !== null && _j !== void 0 ? _j : null,
          notificationPointId:
            (_k = data.notificationPointId) !== null && _k !== void 0
              ? _k
              : null,
          // 匿名化欄位
