...
exports.getLineUserNotificationPoints =
  ...
  exports.addLineUserNotificationPoint =
    void 0;
 ...
 */
exports.addLineUserNotificationPoint = (0, https_1.onRequest)(
  async (req, res) => {
    // CORS handling
    ...
    try {
      ...
      if (
        (gatewayData === null || gatewayData === void 0
          ? void 0
 ...
 * - gatewayId: string (必填，Gateway ID)
 */
exports.removeLineUserNotificationPoint = (0, https_1.onRequest)(
  async (req, res) => {
    // CORS handling
    res.set("Access-Control-Allow-Origin", "*");
    res.set("Access-Control-Allow-Methods", "POST, OPTIONS");
 ...
 * - lineUserId: string (必填，Line 用戶管理 ID)
 */
exports.getLineUserNotificationPoints = (0, https_1.onRequest)(
  async (req, res) => {
    // CORS handling
    res.set("Access-Control-Allow-Origin", "*");
      ...
      for (const gatewayId of notificationPointIds) {
        ...
        if (gatewayDoc.exists) {
          notificationPoints.push(
            Object.assign({ id: gatewayDoc.id }, gatewayDoc.data()),
          );
        }
      }
      res.json({
