...
if (args.length < 4) {
  console.log('\n使用方法：');
  console.log('  node create-saas-user.cjs <email> <password> <name> <tenantId> [phone]');
  console.log('\n範例：');
  console.log('  node create-saas-user.cjs admin@test.com test123456 "測試管理員" tenant_001');
  console.log('  node create-saas-user.cjs admin@test.com test123456 "測試管理員" tenant_001 0912345678');
  console.log('\n');
  process.exit(1);
}
