...
export const AlertDetailScreen = () => {
  ...
  const handleAssign = async () => {
    ...
    setAssigning(true);
    try {
      console.log("Assigning alert with:", {
        alertId: alert.id,
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-2">
            <AlertTriangle
              className={`w-6 h-6 ${getSeverityColor(alert.severity)}`}
            />
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <span
              className={`text-sm font-semibold ${getSeverityColor(alert.severity)}`}
            >
              {alert.severity}
            </span>
          </div>
            ...
            {alert.elder.emergencyContact && (
              <div className="mt-3 p-3 bg-red-50 rounded-lg border border-red-200">
                ...
                {alert.elder.emergencyPhone && (
                  <a
                    href={`tel:${alert.elder.emergencyPhone}`}
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <span className="text-sm text-gray-900">
                {alert.assignedAt &&
                  format(safeToDate(alert.assignedAt), "yyyy/MM/dd HH:mm", {
                    locale: zhTW,
                  })}
              </span>
            </div>
