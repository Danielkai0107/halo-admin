...
export const TenantSelectScreen = ({ memberships, onSelectTenant }: TenantSelectScreenProps) => {
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full text-center">
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-xs text-blue-800 text-left">
              ...
              <br/>1. 如果您已經加入了社區的 LINE OA，系統會自動將您加入社區
              <br/>2. 如果仍未看到社區，請聯絡社區管理員
              <br/>3. 管理員會在後台「App 成員管理」中新增您為成員
              <br/>4. 新增後即可使用本系統
              <br/>
              <br/><strong>提示：</strong>請確認您已加入該社區的 LINE Official Account
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-3">
          {memberships.map((membership) => (
            <button
              key={membership.id}
              onClick={() => membership.tenant && onSelectTenant(membership.tenantId, membership.tenant)}
